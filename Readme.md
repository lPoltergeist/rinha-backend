...
- **Resiliência:** desacoplamento via fila garante que picos de requisições não sobrecarreguem o processamento.
- **Consistência:** o pipeline de Redis + workers mantém contagens e resumos precisos, mesmo em testes de alta carga.
